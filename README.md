...
<p dir="rtl">
ניתן לראות בקלות מן הנתונים איזה אלגוריתם הכי מהיר: A* כשהפונקציה ההיורסטית היא "מרחק-מנהטן", כמו כן, המצב יכול מאוד בקלות להתהפך, כי כשהפונקציה ההיורסטית היא לא קבילה, ניתן לראות כי לאלגוריתם לוקח דווקא אז את מספר הצעדים הגבוה ביותר, ולוקח לו הכי הרבה זמן
בנוסף על כך
</p>
